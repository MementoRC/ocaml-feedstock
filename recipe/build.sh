...
# Called from build_cross_compiler(). Writes the env file to SRC_DIR for the given
# target; no in-tree consumer currently sources this file (unlike the native
# counterpart, which the Stage 3 fast path reads back).
